namespace StringsAndArrays
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("The length of the text string is: " + helloWorld.Length);
            ...
            {
                Console.WriteLine("The word 'World' was not found.");
            ...
            else
            {
                ...
                Console.WriteLine(searchName + " was not found in the names array.");
            }
